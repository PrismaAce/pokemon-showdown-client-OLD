...
export const BattleMoveAnims: AnimTable = {
	...
	victorydance: {
		anim(scene, [attacker]) {
			scene.backgroundEffect('#FFAA00', 800, 0.3, 400);
			BattleOtherAnims.shake.anim(scene, [attacker]);
			scene.showEffect('wisp', {
				x: attacker.x + 40,
				y: attacker.y - 40,
	...
	headlongrush: {
		anim(scene, [attacker, defender]) {
			scene.backgroundEffect('#632600', 700, 0.6);
			scene.showEffect('impact', {
				x: defender.x,
				y: defender.y,
				z: defender.z,
	...
	springtidestorm: {
		anim(scene, [attacker, defender]) {
			scene.backgroundEffect('#FF00FF', 900, 0.8);
	...
	sandsearstorm: {
		anim(scene, [attacker, defender]) {
			scene.backgroundEffect('#FFAA00', 900, 0.8);
	...
	subzerostorm: {
		anim(scene, [attacker, ...defenders]) {
			...
			scene.backgroundEffect('#FFFFFF', 700, 0.5);
			scene.showEffect('waterwisp', {
				x: attacker.x,
				y: attacker.y - 25,
				z: attacker.z,
	...
	triplearrows: {
		anim(scene, [attacker, defender]) {
			scene.backgroundEffect('linear-gradient(#FFAA00 30%, #000000', 2000, 0.4);
			scene.showEffect('electroball', {
				x: attacker.x,
				y: attacker.y,
				z: attacker.z,
...
BattleMoveAnims['bulkup'] = {anim: BattleMoveAnims['swagger'].anim};
...
BattleMoveAnims['shadowdash'] = {anim: BattleMoveAnims['shadowforce'].anim};
...
BattleMoveAnims['takeheart'] = {anim: BattleMoveAnims['recover'].anim};
BattleMoveAnims['powershift'] = {anim: BattleMoveAnims['recover'].anim};
...
BattleMoveAnims['steamball'] = {anim: BattleMoveAnims['weatherball'].anim};
BattleMoveAnims['electronkick'] = {anim: BattleMoveAnims['thunderouskick'].anim};
BattleMoveAnims['glitchout'] = {anim: BattleMoveAnims['teleport'].anim};
BattleMoveAnims['grimroll'] = {anim: BattleMoveAnims['aquafang'].anim};
...
BattleMoveAnims['simplesphere'] = {anim: BattleMoveAnims['technoblast'].anim};
...
BattleMoveAnims['rupture'] = {anim: BattleMoveAnims['earthpower'].anim};
...
BattleMoveAnims['mysticalpower'] = {anim: BattleMoveAnims['psyshock'].anim};
BattleMoveAnims['steelstorm'] = {anim: BattleMoveAnims['magnetbomb'].anim};
